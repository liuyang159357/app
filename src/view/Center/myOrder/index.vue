    ...
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                ...
                <table class="order-item" v-for="item in myOrder.records" :key="item.id">
                    <thead>
                        <tr>
                            <th colspan="5">
                                <span class="ordertitle">{{ item.createTime }} &ensp; 订单编号：{{ item.outTradeNo }} <span
            ...
            <div class="choose-order">
                <PaginatioN @getPageNo="getPageNo" :pageNo="page" :pageSize="limit" :total="myOrder.total"
                    :continues="5" />
            </div>
        </div>
        <!--猜你喜欢-->
...
export default {
    ...
    methods: {
        async getData() {
            let result = await this.$API.reqMyCenterInfo(this.page, this.limit);
            if (result.code == 200) {
